...
┌─────────────────────────────────────────────────────────────────┐
│ PRESENTATION LAYER (5 packages)                                 │
│ Framework Adapters — React ecosystem integrations               │
├─────────────────────────────────────────────────────────────────┤
│  ├─ next/      (Next.js 15+)                                    │
│  ├─ vite/      (Vite 5+)                                        │
│  ├─ svelte/    (Svelte 4/5)                                     │
...
└──────────────────────┬──────────────────────────────────────────┘
                       │ consumes
┌──────────────────────▼──────────────────────────────────────────┐
│ INFRASTRUCTURE LAYER (6 packages)                               │
│ CLI, Tools, External Services, UI Dashboards                    │
├─────────────────────────────────────────────────────────────────┤
│  ├─ cli/            (tw commands)                               │
...
└──────────────────────┬──────────────────────────────────────────┘
                       │ uses
┌──────────────────────▼──────────────────────────────────────────┐
│ DOMAIN LAYER (17 packages)                                      │
│ Business Logic — Reusable across all frameworks                 │
├─────────────────────────────────────────────────────────────────┤
│  ├─ Core DSL:                                                   │
│  │  ├─ compiler/      (CSS compilation engine)                  │
│  │  ├─ parser/syntax/ (AST parsing)                             │
│  │  └─ engine/        (build orchestration)                     │
│  │                                                               │
│  ├─ Feature Domains:                                            │
│  │  ├─ scanner/       (Rust-powered class scanning)             │
│  │  ├─ plugin/        (Plugin system)                           │
│  │  ├─ plugin-api/    (Plugin contracts)                        │
│  │  ├─ plugin-registry/(Plugin discovery)                       │
│  │  ├─ theme/         (Token engine)                            │
│  │  ├─ preset/        (Config presets)                          │
│  │  ├─ animate/       (Animation domain)                        │
│  │  ├─ atomic/        (Atomic CSS generation)                   │
│  │  ├─ runtime/       (React runtime helpers)                   │
│  │  └─ runtime-css/   (CSS runtime generation)                  │
│  │                                                               │
│  └─ Cross-cutting:                                              │
│     ├─ shared/        (Utilities, errors, logging)              │
│     ├─ core/          (Core contracts)                          │
